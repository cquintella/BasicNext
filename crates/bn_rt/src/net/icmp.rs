#![allow(clippy::similar_names)] // reply identifiers pair packet id and source IP.
#![allow(clippy::cast_possible_truncation)] // checksum folds to the wire's 16-bit value.
