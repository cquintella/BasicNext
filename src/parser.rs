...
impl<'a> Parser<'a> {
    ...
    fn base_class(&self) -> Result<Option<crate::ast::TypeReference>, Diagnostic> {
        ...
        Ok(Some(self.type_reference(&line[extends + 1..end])))
    }
    ...
    fn assignment_operator(tokens: &[Token]) -> Option<usize> {
        let mut depth = 0;
    ...
    fn valid_class_header(tokens: &[Token]) -> bool {
        let mut index = 0;
