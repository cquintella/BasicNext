...
One-time donations are welcome through PayPal. Use the following recipient
address in PayPal's send-money flow:

`caquintella@gmail.com`

## Amazon Gift Cards

Digital Amazon gift cards are also welcome. Send them to:

`caquintella@gmail.com`

For supporters in Brazil, please use Amazon.com.br gift cards in BRL.
