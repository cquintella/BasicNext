...
- [Keyword Registry](../../language/0.2/keywords.md)
...
- [Version 0.2 language contract](../../language/0.2/0.2.md)
- [`bn(1)`](../../man/bn.1)
...
For the definitive structural grammar of version 0.2, see:

- [Version 0.2 EBNF](../../language/0.2/0.2.ebnf)
