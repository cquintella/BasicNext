...
Accepted for Basic Next 0.1. Historical: 0.2 withdrew `Float.TryParse` in favour of `BNMath.VAL`; examples below are 0.1-era. `OR` type alternatives, `IS`, `EOF`, and the
