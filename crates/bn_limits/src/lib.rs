...
//! Resource limits for the network-facing libraries and `BNDispatch`, parsed
//! once from the embedded `config/0.4-bnweb-limits.toml` registry.
...
/// # Panics
///
/// Only if the embedded registry is malformed — a build defect, checked by
/// the unit tests below.
#[must_use]
pub fn web_limits() -> &'static WebLimits {
...
#[must_use]
pub fn dispatch_limits() -> &'static DispatchLimits {
    &web_limits().dispatch
}
