# DFD-2 — Process 1.0 Control pipeline (libraries) — TO-BE

**2026-09-21 ownership update:** shared CLI services and backend-specific
driver libraries own Control. Thin bni/bnc entrypoints call them in-process.
Older bnc-only labels below describe the superseded controller deployment;
the logical flows remain applicable. Extract libraries before switching
executables; see [library-first drivers](../../library-first-drivers.md).
...
flowchart TB
  ...
  P13(("1.3 Resolve directories<br/>programs / module-path / plugins"))
  ...
  P13 -->|"C07 resolved dirs<br/>programs-dir, module-path, plugins-dir"| D_cfg
...
| C07 | 1.3 → D_cfg | resolved dirs (programs-dir, module-path list, plugins-dir reserved) |
...
| 1.3 | Resolve directories (programs-dir; **module-path** ordered list; plugins-dir reserved) |
