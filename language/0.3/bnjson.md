...
> **0.6.1c successor:** DOM members, move semantics, and AOT parity are
> normative in [`language/0.6/bnjson.md`](../0.6/bnjson.md). This 0.3 page
> keeps the original Parse/Stringify bounds text.
