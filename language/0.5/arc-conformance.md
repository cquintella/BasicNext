...
- **2026-09-16** — F14–F15 added (pointer regions under ARC; Carlos lock recorded in `language/0.5/0.5.md`). Known failing at lock time on both backends; corrective bucket 0.5.1b.
