...
Toolchain note: historical for the 0.5 line. The package build
inputs are `language/0.6/keywords.md` and `language/0.6/0.6.ebnf`
(root `build.rs` and `crates/bn_frontend/build.rs`).
